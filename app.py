...
if stacked_value_mode != "Pay (%)":  # yüzde modunda anlamsız, kapat
    ...
    st.caption(
        ...
        "yakıt/teknoloji bazlı elektrik üretimi ve kurulu güç değişimlerini (Δ) ifade etmektedir.Kırmızlar azalış, Yeşiller artışı mavi ise kümülatif net değişmi ifade eder."
    )
